...
export const ImageGallery: React.FC<ImageGalleryProps> = ({
  ...
  return (
    <div className="p-6 space-y-6 h-full overflow-y-auto max-h-screen custom-scrollbar-main">
      ...
      {currentMainImage && (
        <div className="bg-gradient-to-br from-pink-50/80 via-white to-pink-100/60 rounded-xl p-3 shadow-lg border border-pink-200 max-h-[650px] overflow-y-auto custom-scrollbar">
